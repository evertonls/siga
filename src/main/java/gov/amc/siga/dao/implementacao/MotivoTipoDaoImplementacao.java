...
public class MotivoTipoDaoImplementacao implements MotivoTipoDao, Serializable {
	...
	@Override
	public List<MotivoTipoDao> listarTodosMotivosTipos() {
		return template.query(QUERY, this::motivoMapRow);
	}
	
	private MotivoTipo motivoMapRow(ResultSet rs, int numRow) throws SQLException {
