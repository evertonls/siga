...
import gov.amc.siga.dao.interfaces.AparelhamentoDao;
import gov.amc.siga.dao.mapper.AparelhoMapper;
import gov.amc.siga.model.Aparelhamento;

@Repository
public class AparelhamentoDaoImplementacao implements AparelhamentoDao, Serializable {
	...
	@Override
	public List<Aparelhamento> listarTodosAparelhos() {
		JdbcTemplate listar = new JdbcTemplate(dataSource);
		return listar.query(sqlListarTodosAparelhos, new AparelhoMapper());
	}

	@Override
	public List<Aparelhamento> listarTodosAparelhosPorProjetoId(Long projetoId) {
		JdbcTemplate listar = new JdbcTemplate(dataSource);
