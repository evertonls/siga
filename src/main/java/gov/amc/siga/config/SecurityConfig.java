	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http
			...
			.antMatchers("/**").requiresSecure()
				...
				.antMatchers("/subadmin/**").permitAll() //.hasAnyRole("ADMIN", "SUBADMIN")
				.antMatchers("/login/**").permitAll()
				.antMatchers("/css/**", "/imagens/**", "/js/**", "/fontes/**", "/docs/**").permitAll()
				.antMatchers("/javax.faces.resource/**").permitAll()
				.antMatchers("usuarios/**").hasAnyRole("ADMIN", "SUBADMIN", "USUARIO")
				.antMatchers("usuarios/cadastro/**").hasAnyRole("ADMIN","SUBADMIN","CADCONTR")
				.anyRequest()
				.authenticated()
