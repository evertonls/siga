...
public class AparelhoProjetoTeste {
	...
	public static void main(String[] args) {
		...
		aparelho.setAparelhoCodigo("PLACA");
...
//		aparelhamento.deletarAparelhoProjeto(aparelho);
		...
		for (AparelhoProjeto aparelhamento2 : listaAparelho) {
			System.out.println("Código: " + aparelhamento2.getAparelhoCodigo() + ", Quantidade: "
					+ aparelhamento2.getQuantidade() + "Projeto id:" + aparelhamento2.getProjetoId());
		}
