...
INSERT INTO permissao (USUARIO_ID, AUTORIZA_COD)
	SELECT 1, 'ROLE_ADMIN' ON CONFLICT (AUTORIZA_COD) DO NOTHING;

INSERT INTO PROJETO (NUMERO, PRANCHA, REVISAO, CONTRATO, DATA_CRIA_PROJ, OBSERVACAO, PROJ_OBRA, PRIORIDADE, DATA_PREVISTA,
	DATA_EQUIPE, DATA_INICIAL, IS_RECAPE, CI_RECAPE, LOCAL_RECAPE, IS_EXECU_REC, DATA_EXE_REC, EQUIPE_COD, usuario_id ) VALUES
	(0603083, '01/01', 'R00', '000/00', CURRENT_DATE, 'RESTRIÇÃO DE ESTACIONAMENTO ENTRE R. BETEU E R. AMÉRICO VESPÚRCIO E R5A NO CANTEIRO CENTRAL',
    'POS-OBRA', 'ALTA', '2020-01-25', '2020-01-30', '2020-01-30', FALSE, 'CI RECAPE', 'MESMO LOCAL', FALSE, '2020-01-30', 'MANUTENCAO', 1)
